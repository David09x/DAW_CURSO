...
public class FrmJuego extends javax.swing.JFrame {
    ...
    private void crearTableroBuscaminas(){
        ...
        tableroBuscaminas.setEventPartidaPerduda(new Consumer<Casella[]>() {
            @Override
            public void accept(Casella[] t) {
                for(Casella casillaConMina: t){
                    botonesTablero[casillaConMina.fila][casillaConMina.col].setText("*");
                }
            }
        });
        tableroBuscaminas.setEventPartidaGuanyada(new Consumer<Casella[]>() {
            @Override
            public void accept(Casella[] t) {
                for(Casella casillaConMina: t){
                    botonesTablero[casillaConMina.fila][casillaConMina.col].setText(":)");
        ...
        tableroBuscaminas.setEventCasellaOberta(new Consumer<Casella>() {
            @Override
            public void accept(Casella t) {
